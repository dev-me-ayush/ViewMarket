  ...
  return (
    ...
    >
      ...
      <section className="scroll-mt-24 space-y-3" id="sec-1">
        ...
        <div className="p-5 bg-amber-950/20 rounded-2xl border border-amber-900/40 shadow-sm space-y-2">
          <h3 className="font-semibold text-amber-300 text-base">Key Findings of SEBI Study on Individual Traders in F&amp;O:</h3>
          <ul className="list-disc pl-5 space-y-1.5 text-sm text-amber-400/90 leading-relaxed font-normal">
            <li><strong className="text-amber-200">9 out of 10 individual traders</strong> in equity Futures and Options incur net financial losses.</li>
            <li>On average, loss-makers registered an annual net loss of approximately <strong className="text-amber-200">₹50,000 to ₹1,25,000</strong>.</li>
            <li>In addition to trading losses, loss-makers expended an additional <strong className="text-amber-200">21% to 28% of net losses</strong> as transaction costs, brokerage, and statutory exchange levies.</li>
      ...
      <section className="scroll-mt-24 space-y-3" id="sec-2">
        ...
        <p className="text-base sm:text-lg text-zinc-300 leading-relaxed font-normal">
          When constructing custom visual strategies or testing parameters via ViewMarket&apos;s compute engine, users face substantial risks of <strong className="text-white">curve-fitting (overfitting)</strong>. A rule set that demonstrated high hypothetical profitability on past candlestick data may fail catastrophically during live market regimes with shifts in volatility or liquidity.
        </p>
        <p className="text-base sm:text-lg text-zinc-300 leading-relaxed font-normal">
          Visual condition triggers (<code className="bg-zinc-850 border border-zinc-700 px-1.5 py-0.5 rounded text-xs font-mono text-zinc-200">IF Indicator A &gt; Indicator B</code>) execute based strictly on mathematical logic. Logic race conditions or incorrect operator chaining can generate unintended order drafts.
        </p>
      </section>
      ...
      <section className="scroll-mt-24 space-y-3" id="sec-3">
        ...
        <ul className="list-disc pl-6 space-y-2 text-base sm:text-lg text-zinc-300 leading-relaxed font-normal">
          <li><strong className="text-white">Daily Token Expiration:</strong> Broker auth tokens expire at the end of each trading day or upon session timeout. Unauthenticated requests will fail silently or reject.</li>
          <li><strong className="text-white">Broker Rate Limiting:</strong> Sending excessive order requests can trigger HTTP 429 rate limit bans from the broker gateway.</li>
          <li><strong className="text-white">Client-Side Internet Drops:</strong> Local Wi-Fi, 4G/5G latency, or browser tab suspension can delay trigger alerts.</li>
        </ul>
      </section>
      ...
      <section className="scroll-mt-24 space-y-3" id="sec-5">
        ...
        <div className="p-5 bg-rose-950/20 rounded-2xl border border-rose-900/40 shadow-sm">
          <p className="text-sm sm:text-base text-rose-300 font-semibold leading-relaxed">
