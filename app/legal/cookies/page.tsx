    ...
    >
      <section className="scroll-mt-24 space-y-3" id="sec-1">
        ...
        <p className="text-base sm:text-lg text-[#281950]/80 leading-relaxed font-normal">
          The current web application does not set an authentication or advertising cookie. When you toggle the dashboard sidebar, it writes a first-party cookie named <code className="bg-purple-100 px-1.5 py-0.5 rounded text-xs font-mono text-[#5300b7]">sidebar_state</code> with the sidebar&apos;s open or collapsed state.
        </p>
        <ul className="list-disc pl-6 space-y-2 text-base sm:text-lg text-[#281950]/80 leading-relaxed font-normal">
          <li><strong>Contents:</strong> The cookie contains only the sidebar state and does not include your name, email address, broker credentials, portfolio data, or authentication token.</li>
          <li><strong>Lifetime:</strong> The cookie expires after seven days unless the sidebar preference is changed again.</li>
          <li><strong>Access:</strong> The cookie is available to ViewMarket client code in your browser and is not used for advertising or cross-site tracking.</li>
        </ul>
      </section>
      ...
      <section className="scroll-mt-24 space-y-3" id="sec-2">
        ...
        <p className="text-base sm:text-lg text-[#281950]/80 leading-relaxed font-normal">
          The current web application does not read or write <code className="bg-purple-100 px-1.5 py-0.5 rounded text-xs font-mono text-[#5300b7]">localStorage</code>, <code className="bg-purple-100 px-1.5 py-0.5 rounded text-xs font-mono text-[#5300b7]">sessionStorage</code>, or <code className="bg-purple-100 px-1.5 py-0.5 rounded text-xs font-mono text-[#5300b7]">IndexedDB</code>. Interactive demonstration state is held in memory and resets when the page reloads or you navigate away.
        </p>
        <p className="text-base sm:text-lg text-[#281950]/80 leading-relaxed font-normal">
