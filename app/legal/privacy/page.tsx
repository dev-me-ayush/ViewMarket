    ...
    >
      ...
      <section className="scroll-mt-24 space-y-3" id="sec-1">
        ...
        <p className="text-base sm:text-lg text-zinc-300 leading-relaxed font-normal">
          ViewMarket serves as a <strong className="text-white">Data Fiduciary</strong> in respect of your account identity data under the provisions of the Digital Personal Data Protection Act, 2023 (DPDP Act) and the Information Technology (Reasonable Security Practices and Procedures and Sensitive Personal Data or Information) Rules, 2011.
        </p>
        <p className="text-base sm:text-lg text-zinc-300 leading-relaxed font-normal">
      ...
      <section className="scroll-mt-24 space-y-3" id="sec-2">
        ...
        <ul className="list-disc pl-6 space-y-2 text-base sm:text-lg text-zinc-300 leading-relaxed font-normal">
          <li><strong className="text-white">Client-Side Storage Only:</strong> Broker API keys, API secrets, TOTP keys, and ephemeral access tokens are stored strictly in client browser memory or encrypted <code className="bg-zinc-850 border border-zinc-700 px-1.5 py-0.5 rounded text-xs font-mono text-zinc-200">IndexedDB</code> on your device.</li>
          <li><strong className="text-white">Zero Server Transmission:</strong> Broker authentication tokens are never transmitted to, relayed through, or stored on ViewMarket backend databases.</li>
        </ul>
      </section>
      ...
      <section className="scroll-mt-24 space-y-3" id="sec-3">
        ...
        <p className="text-base sm:text-lg text-zinc-300 leading-relaxed font-normal">
          Live tick data for Indian equities and F&amp;O streams directly from your broker&apos;s authorized WebSocket servers to your browser client (<code className="bg-zinc-850 border border-zinc-700 px-1.5 py-0.5 rounded text-xs font-mono text-zinc-200">wss://</code>). Zero market ticks pass through or are cached on ViewMarket servers, ensuring full compliance with NSE and BSE market data licensing guidelines.
        </p>
      </section>
      ...
      <section className="scroll-mt-24 space-y-3" id="sec-4">
        ...
        <div className="space-y-3 text-base sm:text-lg text-zinc-300 leading-relaxed font-normal">
          <p>We retain only the minimum data required to deliver the software:</p>
          <ul className="list-disc pl-6 space-y-1.5 text-base">
            <li><strong className="text-white">Authentication Data:</strong> Name, email address, and OAuth provider identifier (Google or GitHub).</li>
            <li><strong className="text-white">User-Authored Strategies:</strong> Saved flowchart conditions, indicator parameters, and backtest history stored in isolated user workspaces.</li>
            <li><strong className="text-white">Billing Records:</strong> Transaction IDs and tax invoice data processed securely via Razorpay or Stripe. ViewMarket never stores credit card or bank credentials.</li>
          </ul>
        </div>
      </section>
